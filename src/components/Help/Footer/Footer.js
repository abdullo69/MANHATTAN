    ...
    return (
        <div>
            <div className='Helpfooter'>
                <div className='Helpfooter_navbar'>
                    <h1>JOIN OUR ADICLUB & GET <br /> 15% OFF</h1>
                    <button>SIGN UP FOR FREE</button>
                </div>

                <div className='Helpfooter_carts'>
                    <div className='Helpfooter_cart'>
                        <h3>PRODUCTS</h3>
                        <p>Shoes</p>
                        <p>Clothing</p>
                        <p>Accessories</p>
            ...
            <div className='Helpfooter2'>
                <div className='Helpfooter2_data'><p>Data settings |
