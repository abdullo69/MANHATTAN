    ...
    return (
        <div>
            <div className='Womenfooter'>
                <div className='Womenfooter_navbar'>
                    <h1>JOIN OUR ADICLUB & GET <br /> 15% OFF</h1>
                    <button>SIGN UP FOR FREE</button>
                </div>

                <div className='Womenfooter_carts'>
                    <div className='Womenfooter_cart'>
                        <h3>PRODUCTS</h3>
                        <p>Shoes</p>
                        <p>Clothing</p>
                        <p>Accessories</p>
                    ...
                    <div className='Womenfooter_cart'>
                        <h3>FOLLOW US</h3>
                        <div className='iconss'>                 <p><BsFacebook style={{ fontSize: "20px", marginTop: "10px", cursor: "pointer" }} /></p>
                            ...
                            <p><BsTelegram style={{ fontSize: "20px", marginTop: "10px", cursor: "pointer" }} /></p></div>
                    </div>

                </div>

            </div>
            <div className='Womenfooter2'>
                <div className='Womenfooter2_data'><p>Data settings |
