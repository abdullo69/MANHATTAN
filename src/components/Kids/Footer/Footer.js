    ...
    return (
        <div>
            <div className='Kidsfooter'>
                <div className='Kidsfooter_navbar'>
                    <h1>JOIN OUR ADICLUB & GET <br /> 15% OFF</h1>
                    <button>SIGN UP FOR FREE</button>
                </div>

                <div className='Kidsfooter_carts'>
                    <div className='Kidsfooter_cart'>
                        <h3>PRODUCTS</h3>
                        <p>Shoes</p>
                        <p>Clothing</p>
                        <p>Accessories</p>
            ...
            <div className='Kidsfooter2'>
                <div className='Kidsfooter2_data'><p>Data settings |
